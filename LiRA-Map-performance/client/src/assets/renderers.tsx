...
import { Rectangle, Circle, Polyline, LayerGroup, Popup, Tooltip } from 'react-leaflet'
import 'leaflet-hotline'

import { RideData, PointData } from './models'
import { Measurement } from '../Components/Dashboard/Measurements'
...
const Renderers: Renderer[] = [
    ...
    {
        name: 'Hotpoints', //dark points on map
